...
<?php foreach($exercises_selected8 as $exercise_selected8): ?>

<?php

$multiple_name_exercise8 = $exercise_selected8['exercise_title'];
$single_name_exercise8 = explode(',', $multiple_name_exercise8);
?>

<?php foreach ($single_name_exercise8 as $value_name_exercise8) { ?>
<option data-img-src="<?php echo SITE_URL ?>/images/<?php echo $exercise_selected8['exercise_image']; ?>" value="<?php echo $exercise_selected8['exercise_id']; ?>" selected><?php echo $value_name_exercise8 ?></option>
<?php } ?>
