...
$sql = "SELECT posts.*,tags.tag_title AS tag_title FROM posts,tags WHERE posts.post_tag = tags.tag_id AND posts.post_id='".$_GET["post"]."' LIMIT 1";
mysqli_set_charset($connection, "utf8");
...
<?php
    ...
    if(empty($_GET["tag"]) && empty($_GET["post"])){
