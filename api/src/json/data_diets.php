...
$sql = "SELECT diets.*,categories.category_title AS category_title FROM diets,categories WHERE diets.diet_category = categories.category_id AND diets.diet_id='".$_GET["diet"]."' LIMIT 1";
mysqli_set_charset($connection, "utf8");
...
<?php
    ...
    if(empty($_GET["category"]) && empty($_GET["diet"])){
