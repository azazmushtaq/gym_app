...
$sql .= " JOIN we_day8 ON we_day8.exercise_id = exercises.exercise_id JOIN workouts ON we_day8.workout_id = workouts.workout_id WHERE we_day8.workout_id = ".$_GET["id"];
