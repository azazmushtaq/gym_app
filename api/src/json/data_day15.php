...
$sql = "SELECT exercises.*,workouts.workout_id, equipments.equipment_title AS equipment_title, levels.level_title AS level_title, we_day15.workout_id AS workout_id FROM exercises JOIN levels ON exercises.exercise_level = levels.level_id JOIN equipments ON exercises.exercise_equipment = equipments.equipment_id JOIN we_day15 ON we_day15.exercise_id = exercises.exercise_id JOIN workouts ON we_day15.workout_id = workouts.workout_id WHERE we_day15.workout_id='".$_GET["workout"]."'";
...
$sql = "SELECT exercises.*,workouts.workout_id, equipments.equipment_title AS equipment_title, levels.level_title AS level_title, we_day15.workout_id AS workout_id FROM exercises JOIN levels ON exercises.exercise_level = levels.level_id JOIN equipments ON exercises.exercise_equipment = equipments.equipment_id JOIN we_day15 ON we_day15.exercise_id = exercises.exercise_id JOIN workouts ON we_day15.workout_id = workouts.workout_id";
